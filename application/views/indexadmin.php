  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/indexadmin/dashboard'); ?>">
        <i class="fas fa-home"></i>
          <span>Dashboard</span></a>
          
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/indexadmin/cruduser'); ?>">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/indexadmin/crudmenu'); ?>">
      ...
      <!-- <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/indexadmin/crudorder'); ?>">
        <i class="fas fa-shopping-cart"></i>
          <span>Order</span></a>
          
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('admin/indexadmin/crudtransaksi'); ?>">
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                ...
                <img class="img-profile rounded-circle" src="<?php echo base_url().'assets/'.$this->session->userdata('image'); ?>">
              </a>
        ...
        <div class="container-fluid">
          ...
          <div class="row" >
           ...
           <center>  
              ...
              if ($this->uri->segment(3) == "dashboard") {
              ...
              else  if ($this->uri->segment(3) == "cruduser") {
                ...
                // }
                // else  if ($this->uri->segment(3) == "crudtransaksi") {
                //   $this->load->view('crudtransaksi');
                // }
                ...
                else  if ($this->uri->segment(2) == "edit_data_menu") {
                  $this->load->view('edit_data_menu');
                  
                }
                
                // else  if ($this->uri->segment(2) == "bayar") {
