            ...
            <div class="table-responsive mb-4 mt-4">
              ...
              ?>
               <tr>
                  ...
                  <td>
                  <div class="col-12">
                   <a href="<?php echo site_url('admin/edit_data_menu/'.$datas->id_menu); ?>"> <button  class=" btn btn-success btn-sm edit_data" style="width: 100%;" ><i class="fas fa-edit"></i>   </button></a>
                    </div>
...
<div class="modal fade" id="add" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <form action="<?php echo site_url('admin/simpan_data_menu');?>" method="post" enctype="multipart/form-data">
                  ...
                  <div class="modal-content">
                   ...
                   <center>  <img src="<?php echo base_url(); ?>assets/img/seru.png" style="width:150px" class="card-img" alt="..."></center><br>
                    ...
                    <div class="modal-footer">
                      ...
                      <a href="<?php echo site_url('admin/delete_data_menu/'.$datas->id_menu); ?>"> <button type="button" class="btn btn-primary">Yes</button></a>
                    </div>
                  </div>
                </div>
              </div>
