  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('owner/indexowner/dashboardowner'); ?>">
        <i class="fas fa-home"></i>
          <span>Dashboard</span></a>
          
      </li>
      <li class="nav-item active">
        <a class="nav-link" href="<?php echo site_url('owner/indexowner/report'); ?>">
        ...
        <div class="container-fluid">
          ...
          <div class="row" >
           ...
           <center>  
              ...
              <?php
              if ($this->uri->segment(3) == "dashboardowner") {
                  $this->load->view('dashboardowner');
                  
                }
               else if ($this->uri->segment(3) == "report") {
