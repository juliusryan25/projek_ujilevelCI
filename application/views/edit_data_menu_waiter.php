...
<div class="col-6"><div class="card">
  ...
  <div class="card-body">
  <form action="<?php echo site_url('waiter/aksi_edit_menu_waiter');?>" method="post" enctype="multipart/form-data">
  <?php
    ...
    <a href="<?php echo site_url('waiter/indexwaiter/crudmenu'); ?>"><button  class="btn btn-danger"> Cancel</button></a>
  </div></div> </div>
</div></div>
